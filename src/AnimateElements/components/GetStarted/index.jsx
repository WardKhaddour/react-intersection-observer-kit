...
function GetStarted({ isActive }) {
  ...
  return (
    <section
      ref={ref}
      className={`min-h-[70vh] text-[#CEDEBD] ${
        isActive ? 'bg-[#435334]' : 'bg-gray-100'
    ...
    >
      ...
      <p>
        Wrap your components with ObserverProvider and get access to our amazing
        hooks!
      </p>
      <pre className="bg-gray-200 p-4 rounded-md text-gray-950 mt-4 w-fit shadow-lg">
        <code>{`
