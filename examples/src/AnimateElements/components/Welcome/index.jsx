  ...
  return (
    <section
      ...
      className={`min-h-[70vh] text-center ${
        isActive ? 'bg-[#435334]' : 'bg-gray-200'
      } m-10 rounded-md flex items-center justify-center flex-col gap-5 transition-colors duration-300 shadow-lg text-[#CEDEBD]`}
    >
      <h1 className="font-bold text-3xl">
        Welcome to React Intersection Observer Kit
      </h1>
      <p>
